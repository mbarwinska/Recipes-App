package com.spring.RecipeProject.bootstrap;

import com.spring.RecipeProject.domain.*;
import com.spring.RecipeProject.repositories.CategoryRepository;
import com.spring.RecipeProject.repositories.RecipeRepository;
import com.spring.RecipeProject.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacos.getCategories().add(americanCat);
        tacos.getCategories().add(mexicanCat);
